...
const initDB = async () => {
    ...
    try {
        ...
        ('lector',        'Consulta y lectura de libros') ON CONFLICT (nombre_roles) DO NOTHING;
    `);

        // Admin por defecto (RF6, RF7)
        ...
        if (existeAdmin.length === 0) {
            ...
            await client.query( `INSERT INTO usuarios (nombre_usuarios, email_usuarios, password_usuarios, id_roles) VALUES ($1, $2, $3, $4)`,
                [
